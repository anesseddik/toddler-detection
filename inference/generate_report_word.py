...
insert_plot("confusion_matrix_normalized.png", "Figure 2 - Normalized Confusion Matrix")
insert_plot("BoxPR_curve.png",                 "Figure 3 - Precision-Recall Curve")
insert_plot("BoxF1_curve.png",                 "Figure 4 - F1-Confidence Curve")
insert_plot("labels.jpg",                      "Figure 5 - Label Distribution & Bounding Box Statistics")
insert_plot("val_batch0_pred.jpg",             "Figure 6 - Validation Batch 0: Predictions")
insert_plot("val_batch1_pred.jpg",             "Figure 7 - Validation Batch 1: Predictions")
