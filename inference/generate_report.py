...
pdf.body("Validation set metrics at best epoch (epoch 89):")
pdf.table(
    ...
    rows=[
        ...
        ["mAP50 (val)",        "96.53%", "Area under P-R curve at IoU >= 0.5"],
        ...
        ["Parameters",         "11,125,971", "YOLOv8s"],
        ["Confidence thresh.", "0.4", "Used at inference and FP testing"],
    ],
    col_widths=[38, 28, 124]
)
pdf.body(
    "Note on accuracy in object detection: there is no single accuracy metric equivalent to "
    "classification accuracy. Precision, Recall, F1, and mAP are the standard measures. "
...
pdf.insert_plot("confusion_matrix_normalized.png", "Figure 2  - Normalized Confusion Matrix (val set)")
pdf.insert_plot("confusion_matrix.png",            "Figure 3  - Absolute Confusion Matrix (val set)")
pdf.insert_plot("BoxPR_curve.png",                 "Figure 4  - Precision-Recall Curve  |  AP = 0.965")
pdf.insert_plot("BoxP_curve.png",                  "Figure 5  - Precision vs Confidence Curve")
pdf.insert_plot("BoxR_curve.png",                  "Figure 6  - Recall vs Confidence Curve")
pdf.insert_plot("BoxF1_curve.png",                 "Figure 7  - F1 vs Confidence Curve  |  Best F1 = 0.939 @ conf 0.424")
pdf.insert_plot("labels.jpg",                      "Figure 8  - Label Distribution & Bounding Box Statistics")
pdf.insert_plot("train_batch0.jpg",                "Figure 9  - Training Batch 0: Ground Truth Annotations")
pdf.insert_plot("val_batch0_labels.jpg",           "Figure 10 - Validation Batch 0: Ground Truth Labels")
pdf.insert_plot("val_batch0_pred.jpg",             "Figure 11 - Validation Batch 0: Model Predictions")
pdf.insert_plot("val_batch1_labels.jpg",           "Figure 12 - Validation Batch 1: Ground Truth Labels")
pdf.insert_plot("val_batch1_pred.jpg",             "Figure 13 - Validation Batch 1: Model Predictions")
pdf.insert_plot("val_batch2_labels.jpg",           "Figure 14 - Validation Batch 2: Ground Truth Labels")
pdf.insert_plot("val_batch2_pred.jpg",             "Figure 15 - Validation Batch 2: Model Predictions")
